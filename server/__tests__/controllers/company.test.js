...
describe('Company Controller', () => {
  ...
  describe('updateProfile', () => {
    ...
    it('should return 404 when company not found', async () => {
      ...
      Company.findByUserId.mockResolvedValueOnce(null);
      ...
      // Assertions
      expect(Company.findByUserId).toHaveBeenCalledWith(999);
    ...
    it('should return 500 when an error occurs', async () => {
      ...
      Company.findByUserId.mockRejectedValueOnce(error);
  ...
  describe('getProfile', () => {
    ...
    it('should return 404 when company profile not found', async () => {
      ...
      expect(Company.findByUserId).toHaveBeenCalledWith(999);
      expect(res.status).toHaveBeenCalledWith(404);
      expect(res.json).toHaveBeenCalledWith({ message: 'Company profile not found' });
    });
  ...
  describe('createTrip', () => {
    it('should create a trip successfully', async () => {
      ...
      // Mock the model functions
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      Trip.create.mockResolvedValueOnce(5);
  ...
  describe('getTrips', () => {
    it('should return trips for a company', async () => {
      ...
      // Mock the model functions
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      Trip.findByCompanyId.mockResolvedValueOnce(mockTrips);
      ...
      // Assertions
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(Trip.findByCompanyId).toHaveBeenCalledWith(1);
  ...
  describe('updateTrip', () => {
    it('should update a trip successfully', async () => {
      ...
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      Trip.findById.mockResolvedValueOnce(mockTrip);
      Trip.update.mockResolvedValueOnce(true);
  ...
  describe('deleteTrip', () => {
    it('should delete a trip successfully', async () => {
      ...
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      Trip.findById.mockResolvedValueOnce(mockTrip);
      Trip.delete.mockResolvedValueOnce(true);
      ...
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(Trip.findById).toHaveBeenCalledWith('1');
      expect(Trip.delete).toHaveBeenCalledWith('1');
      expect(res.json).toHaveBeenCalledWith({
  ...
  describe('sendDriverRequest', () => {
    it('should send a driver request successfully', async () => {
      ...
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(Trip.findById).toHaveBeenCalledWith('1');
      expect(TripRequest.findByTripAndDriver).toHaveBeenCalledWith('1', 2);
  ...
  describe('getAvailableDrivers', () => {
    it('should return available drivers for a trip', async () => {
      ...
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      Trip.findById.mockResolvedValueOnce(mockTrip);
      Trip.getAvailableDriversForTrip.mockResolvedValueOnce(mockDrivers);
      ...
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(Trip.findById).toHaveBeenCalledWith('1');
      expect(Trip.getAvailableDriversForTrip).toHaveBeenCalledWith('1');
    ...
    it('should return 403 when trip does not belong to company', async () => {
      ...
      expect(Trip.findById).toHaveBeenCalledWith('1');
      expect(res.status).toHaveBeenCalledWith(403);
      expect(res.json).toHaveBeenCalledWith({ message: 'Not authorized to access this trip' });
    });
    ...
    it('should return 500 when an error occurs', async () => {
      ...
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(res.status).toHaveBeenCalledWith(500);
      expect(res.json).toHaveBeenCalledWith({ message: 'Server error while fetching available drivers.' });
    });
  });
  ...
  describe('rateDriver', () => {
    it('should rate a driver successfully', async () => {
      ...
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      Trip.findById.mockResolvedValueOnce(mockTrip);
      Rating.create.mockResolvedValueOnce(mockRating);
      Driver.updateRating.mockResolvedValueOnce(true);
      ...
      expect(Driver.updateRating).toHaveBeenCalledWith(2);
      expect(res.status).toHaveBeenCalledWith(201);
      expect(res.json).toHaveBeenCalledWith({
  ...
  describe('getTripRequests', () => {
    it('should return trip requests for a company', async () => {
      ...
      // Mock the model functions
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      TripRequest.getByCompanyId.mockResolvedValueOnce(mockRequests);
      ...
      // Assertions
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(TripRequest.getByCompanyId).toHaveBeenCalledWith(1);
  ...
  describe('cancelTripRequest', () => {
    it('should cancel a trip request successfully', async () => {
      ...
      expect(Trip.findById).toHaveBeenCalledWith(1);
      expect(TripRequest.updateStatus).toHaveBeenCalledWith('1', 'cancelled');
  ...
  describe('getTripRequestCount', () => {
    it('should return trip request count for a company', async () => {
      ...
      // Mock the model functions
      Company.findByUserId.mockResolvedValueOnce(mockCompany);
      TripRequest.countPendingByCompanyId.mockResolvedValueOnce(mockCount);
      ...
      // Assertions
      expect(Company.findByUserId).toHaveBeenCalledWith(5);
      expect(TripRequest.countPendingByCompanyId).toHaveBeenCalledWith(1);
