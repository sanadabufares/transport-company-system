  ...
  return (
    <div>
      ...
      <div className="alert alert-light border-start border-4 border-primary mb-4" dir="rtl">
        <strong>📊 לוח בקרה - נהג</strong>
        <p className="mb-0 mt-1">כאן תוכל לראות את סטטוס הזמינות שלך, בקשות נסיעה חדשות, נסיעות זמינות, והרווחים שלך. עדכן את הזמינות שלך כדי לקבל הצעות עבודה.</p>
      </div>
